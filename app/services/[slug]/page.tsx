                    ...
                    {service.highlights.map((highlight, index) => (
                      ...
                      >
                        <div className="flex items-start gap-4">
                          <div className="w-10 h-10 bg-primary-100 text-primary rounded-lg flex items-center justify-center font-bold text-lg flex-shrink-0">
                ...
                <dl className="space-y-4 mb-6">
                  {service.priceRange && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <dt className="text-sm text-secondary">Typical Price Range</dt>
                  ...
                  {service.typicalDuration && (
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <dt className="text-sm text-secondary">Typical Duration</dt>
                        <dd className="font-medium text-dark">
                          {service.typicalDuration}
                        </dd>
                      </div>
      ...
      <section className="bg-primary py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto px-8 py-4 bg-accent text-dark font-semibold rounded-lg hover:bg-accent-600 transition-colors"
            >
              Contact Us
            </Link>
            {settings.phone && (
              <a
                href={`tel:${settings.phone.replace(/\D/g, '')}`}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-lg border-2 border-white/30 hover:bg-white hover:text-primary transition-colors"
              >
